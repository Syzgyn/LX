...
public abstract class BufferPattern extends LXPattern {
	public String getAuthor() {
		return "Mark C. Slee";
	}

	public final CompoundParameter speedRaw = (CompoundParameter) new CompoundParameter("Speed", 256, 2048, 64)
			.setExponent(.5).setDescription("Speed of the wave propagation");
